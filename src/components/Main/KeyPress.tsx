      ...
      return (
        <p
          className={clsx(
            ...
            `,
            {
              'border-black': themeState.theme === 'light' && guessState.guessStatus === null,
            },
            {
              'border-white': themeState.theme === 'dark' && guessState.guessStatus === null,
            },
            {
              'border-blue-dark': themeState.theme === 'light' && guessState.guessStatus === 'correct',
            },
            {
              'border-orange': themeState.theme === 'dark' && guessState.guessStatus === 'correct',
            },
